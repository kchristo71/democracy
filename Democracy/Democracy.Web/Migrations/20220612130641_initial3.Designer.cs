...
namespace Democracy.Web.Migrations
{
    ...
    [Migration("20220612130641_initial3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Democracy.Web.Domain.AttributeValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("AttributeValue");
                });
            ...
            modelBuilder.Entity("Democracy.Web.Domain.PollAttributeValue", b =>
                {
                    b.HasBaseType("Democracy.Web.Domain.AttributeValue");
                    ...
                    b.HasDiscriminator().HasValue("PollAttributeValue");
                });
            ...
            modelBuilder.Entity("Democracy.Web.Domain.PollAttributeValue", b =>
                {
                    b.HasOne("Democracy.Web.Domain.AttributeValue", "AttributeValue")
                        .WithMany()
